 ...
 */
public class RecommandFragment extends Fragment implements Callback<Recommand>, PtrHandler {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        HttpUtils.getVedioService().getData("suggest",1).enqueue(this);
    ...
    private void getData(int page) {
        HttpUtils.getVedioService().getData("suggest", page).enqueue(this);
    }
    @Override
    ...
    public abstract class EndlessRecyclerOnScrollListener extends
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            //总的条目数，（内部实现是获取布局管理器对应的adapter中的getCount（）方法）
