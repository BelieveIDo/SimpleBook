 ...
 * 精华页面
 */
public class EssenceFragment extends Fragment implements Callback<Recommand>, PtrHandler {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        HttpUtils.getVedioService().getData("day",1).enqueue(this);
    ...
    private void getData(int page) {
        HttpUtils.getVedioService().getData("day", page).enqueue(this);
    }
    @Override
